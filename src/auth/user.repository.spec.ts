...
const mockCredentialsDto = { username: 'TestUsername', password: 'secret' };
describe('UserRepository', () => {
  ...
  describe('signUp', () => {
    ...
    it('throws InternalServerError if exception is unhandled', () => {
      save.mockRejectedValue({code: '233505'});
      expect(userRepository.signUp(mockCredentialsDto)).rejects.toThrow(InternalServerErrorException);
    });
  });

  describe('valudateUserPassword', () => {
    let user;
  ...
  describe('hashPassword', () => {
    it('calls bycript.hash to generate a hash', async () => {
